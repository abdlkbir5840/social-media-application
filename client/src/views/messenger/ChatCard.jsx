...
function ChatCard() {
  return (<>
     <div class="wind  col-lg-7 col-xl-8 border">
      ...
      <div class="position-relative chat-card">
        <div class="chat-messages p-4">
          <div class="chat-message-right pb-4">
            ...
            <div class="flex-shrink-1 bg-light rounded py-2 px-3 mr-3">
              <div class="font-weight-bold mb-1 text-muted">You</div>
          ...
          <div class="chat-message-left pb-4">
            ...
            <div class="flex-shrink-1 bg-primary text-light rounded py-2 px-3 ml-3">
              <div class="font-weight-bold mb-1 text-light">Sharon Lessman</div>
